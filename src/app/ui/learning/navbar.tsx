...
import { Menu, ChevronUp, Lock, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto relative">
        <div className="flex items-center justify-between gap-5">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-zinc-800 px-6 py-2 flex items-center justify-between w-full"
          >
            <div
