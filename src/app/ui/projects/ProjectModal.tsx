      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-xl w-full max-w-6xl h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-4 border-b dark:border-zinc-700">
          <input
            ...
            className="text-xl font-bold bg-transparent border-none focus:outline-none dark:text-white"
          />
        ...
        <div className="flex justify-between p-4 border-t dark:border-zinc-700">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:text-white cursor-pointer"
            >
              Cancelar
            </button>
            <button
              onClick={handleSave}
              disabled={saving}
              className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white px-4 py-2 rounded flex items-center gap-2 cursor-pointer"
            >
